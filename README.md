...
project](https://web.archive.org/web/20230530103143/https://geti2p.net/).
For instructions, see below, and more information is on
[geti2p.net](https://web.archive.org/web/20230530103143/https://geti2p.net/debian).

For Ubuntu, we recommend [our
PPA](https://web.archive.org/web/20230530103143/https://launchpad.net/~i2p-maintainers/+archive/ubuntu/i2p)
instead, and instructions are on
[geti2p.net](https://web.archive.org/web/20230530103143/https://geti2p.net/debian).

The signing key for this repo [may be downloaded
here](https://web.archive.org/web/20230530103143/https://geti2p.net/_static/i2p-debian-repo.key.asc).
...
-   **2017-01-06** New [status notes on the i2p
    package](https://web.archive.org/web/20230530103143/https://github.com/i2p/i2p.i2p/blob/master/debian-alt/doc/dependencies.txt)
    now available.
-   **2016-11-04** https now supported on host
    [deb.i2p2.de](https://web.archive.org/web/20230530103143/https://deb.i2p2.de/).
    http is still available on host
    [deb.i2p2.no](https://web.archive.org/web/20230530103143/http://deb.i2p2.no/).
...
-   **2014-03-09** Now serving
    [Anoncoin](https://web.archive.org/web/20230530103143/http://www.anoncoin.net/)
...
on the [I2P Bug
Tracker](https://web.archive.org/web/20230530103143/https://trac.i2p2.de/newticket?component=package/debian&owner=killyourtv&cc=killyourtv@mail.i2p).
Bugs for Anoncoin should be reported on its [Github project
page](https://web.archive.org/web/20230530103143/https://github.com/anoncoin/anoncoin/issues).
...
::: package
[i2p]{.name} [(2.2.1-1ubuntu1[, [main]{.main}]{.section})]{.version} -
[Invisible Internet Project (I2P) - anonymous
network]{.short_description}\
[Binary for arch [[all (70.9
KB)](pool/main/i/i2p/i2p_2.2.1-1ubuntu1_all.deb)]{.archs} \| [[Source
...
::: package
[i2p-router]{.name} [(2.2.1-1ubuntu1[,
[main]{.main}]{.section})]{.version} - [Invisible Internet Project
(I2P) - Router]{.short_description}\
[Binary for arch [[all (11.0
MB)](pool/main/i/i2p/i2p-router_2.2.1-1ubuntu1_all.deb)]{.archs} \|
[[Source dir](pool/main/i/i2p/)]{.source} ]{.linkline}\
\
...
::: package
[libjbigi-jni]{.name} [(2.2.1-1ubuntu1[,
[main]{.main}]{.section})]{.version} - [Invisible Internet Project
(I2P) - libjbigi library]{.short_description}\
[Binary for arch [[amd64 (271.7
KB)](pool/main/i/i2p/libjbigi-jni_2.2.1-1ubuntu1_amd64.deb), [arm64
(271.0 KB)](pool/main/i/i2p/libjbigi-jni_2.2.1-1ubuntu1_arm64.deb),
[armhf (270.6
KB)](pool/main/i/i2p/libjbigi-jni_2.2.1-1ubuntu1_armhf.deb), [ppc64el
(271.5 KB)](pool/main/i/i2p/libjbigi-jni_2.2.1-1ubuntu1_ppc64el.deb),
[s390x (270.8
KB)](pool/main/i/i2p/libjbigi-jni_2.2.1-1ubuntu1_s390x.deb)]{.archs} \|
[[Source dir](pool/main/i/i2p/)]{.source} ]{.linkline}\
\
...
::: package
[i2p]{.name} [(2.2.1-1\~lunar+1[, [main]{.main}]{.section})]{.version} -
[Invisible Internet Project (I2P) - anonymous
network]{.short_description}\
[Binary for arch [[all (74.8
KB)](pool/main/i/i2p/i2p_2.2.1-1~lunar+1_all.deb)]{.archs} \| [[Source
dir](pool/main/i/i2p/)]{.source} ]{.linkline}\
\
...
::: package
[i2p-doc]{.name} [(2.2.1-1\~lunar+1[,
[main]{.main}]{.section})]{.version} - [Invisible Internet Project
(I2P) - developer documentation]{.short_description}\
[Binary for arch [[all (3.0
MB)](pool/main/i/i2p/i2p-doc_2.2.1-1~lunar+1_all.deb)]{.archs} \|
[[Source dir](pool/main/i/i2p/)]{.source} ]{.linkline}\
\
...
::: package
[i2p-router]{.name} [(2.2.1-1\~lunar+1[,
[main]{.main}]{.section})]{.version} - [Invisible Internet Project
(I2P) - Router]{.short_description}\
[Binary for arch [[all (11.1
MB)](pool/main/i/i2p/i2p-router_2.2.1-1~lunar+1_all.deb)]{.archs} \|
[[Source dir](pool/main/i/i2p/)]{.source} ]{.linkline}\
\
...
::: package
[libjbigi-jni]{.name} [(2.2.1-1\~lunar+1[,
[main]{.main}]{.section})]{.version} - [Invisible Internet Project
(I2P) - libjbigi library]{.short_description}\
[Binary for arch [[amd64 (259.3
KB)](pool/main/i/i2p/libjbigi-jni_2.2.1-1~lunar+1_amd64.deb), [armhf
(258.1
KB)](pool/main/i/i2p/libjbigi-jni_2.2.1-1~lunar+1_armhf.deb)]{.archs} \|
[[Source dir](pool/main/i/i2p/)]{.source} ]{.linkline}\
\
