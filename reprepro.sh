...
reprepro -v -b ./debian_reprepro --confdir ./debian/conf --logdir ./debian_logs copysrc sid lunar i2p-keyring
reprepro -v -b ./debian_reprepro --confdir ./debian/conf --logdir ./debian_logs copysrc bookworm focal i2p-keyring
reprepro -v -b ./debian_reprepro --confdir ./debian/conf --logdir ./debian_logs copysrc bullseye focal i2p-keyring
reprepro -v -b ./debian_reprepro --confdir ./debian/conf --logdir ./debian_logs copysrc buster focal i2p-keyring
